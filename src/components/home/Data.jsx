...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Delwar Hosen<svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
                    fill="none"
            ...
            <p className="home__description md:m-0 mr-10">Web Developer | MERN Stack | UI/UX | WordPress
            I build modern, responsive websites and web apps that look great and perform even better.</p>
            <a href="#contact" className="button button--flex"> Say Hello <TbSend></TbSend></a>
        </div>
    );
};
